...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Calcula cúal es el país al que representa el atleta buscado
	 * 
	 * @param nombre del atleta que ddel que se quiere conocer el pais
	 * @return El país al que el atleta representa 
	 */
	
	public Pais PaisdelAtleta(String nomatleta)
	{
		Pais resultado = null;
		Atleta elAtleta = buscarAtleta(nomatleta);
		if (elAtleta != null)
		{
